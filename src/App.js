    ...
    <section className="relative w-full h-full bg-black" data-tails-scripts="//unpkg.com/alpinejs">
        <div className="relative z-40 h-full px-10 mx-auto max-w-7xl">
                ...
                <div className="relative z-20 flex items-center justify-between w-full md:w-auto">
                    <div>
                        <a href="#_" className="text-lg font-semibold text-white md:text-xl">
                                ...
                                <span className="text-xl leading-none select-none">base<span className="text-yellow-300">.</span></span>
                            </a>
            ...
            <div className="flex flex-col items-center justify-center w-full h-full py-32 -mt-20 sm:py-48 md:py-64"> 
                <h1 className="mb-20 text-5xl font-extrabold leading-tight text-left text-white sm:text-center lg:text-7xl lg:leading-tight">Find your content. <br></br><span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-red-400 to-pink-400">Create your community</span><span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-red-400 to-yellow-300">.</span></h1>
                ...
                <p className="flex items-center mt-4 text-xs text-gray-400">
                    ...
                    <span>Free to Try. Join today & connect with others.</span>
                </p>
            </div>
        </div>
        ...
        <div className="bottom-0 left-0 z-30 w-full h-full bg-cover" url="http://devdojo.com.s3.us-east-1.amazonaws.com/tails/images/mesh-bg.svg')"></div>
    </section>
    </div>
  );
}
