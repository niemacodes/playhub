          ...
          <div className="px-3 py-3 lg:px-5 lg:pl-3">
             <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-center ">
                   ...
                   <a href="#_" className="enableEthereumButton hidden sm:inline-flex ml-5 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3" onClick={connectWebsite}>{connected? "Connected":"Connect Wallet"}
                   </a>
                </div>
             </div>
          </div>
